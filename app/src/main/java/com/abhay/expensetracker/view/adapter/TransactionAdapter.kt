package com.abhay.expensetracker.view.adapter
...
import com.abhay.expensetracker.databinding.ItemTransactionLayoutBinding
        ...
        holder.binding.apply {
            ...
            when (item.transactionType) {
                "Income" -> {
                    transactionAmount.setTextColor(
                        ContextCompat.getColor(
                            transactionAmount.context, R.color.income
                        )
                    )
                ...
                "Expense" -> {
                    transactionAmount.setTextColor(
                        ContextCompat.getColor(
                            transactionAmount.context, R.color.expense
                        )
                    )
                    transactionAmount.text = "- ".plus(indianRupee(item.amount))
                }
